...
SERVER = "3.101.38.107"#13.52.247.117"
ADDR = (SERVER, PORT)
...
def plot_results(path, x_history, y_history, timeout):
    ...
    plt.legend()
    # plt.show()
    plt.savefig(f"Dynamic_Transfer_PathNum_{path_num}_low_traffic.png")
...
def reset_sim(path_var, timeout):
    ...
    global num_state_sent, local_cmd_cnt, cloud_cmd_cnt, timeout_cnt, dynamic_deadline
...
def start_sim(path_var, timeout):
    ...
    global x_history, y_history, num_state_sent, dynamic_deadline
    ...
    while True:
        ...
        #     print("State machine at: ", curr_state)
            ...
            print("Dynamic deadline: ", dynamic_deadline)
