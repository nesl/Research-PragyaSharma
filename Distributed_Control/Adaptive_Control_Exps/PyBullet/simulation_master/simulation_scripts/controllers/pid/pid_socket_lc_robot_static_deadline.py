...
SERVER = "54.177.79.188" #"18.144.167.144"
ADDR = (SERVER, PORT)
...
def plot_results(path, x_history, y_history, timeout):
    ...
    plt.figure()
    plt.title("PID Tracking Results - Static Local")
    ...
    plt.legend()
    # plt.show()
    plt.savefig(f"Static_Local_PathNum_{path_num}_Timeout_{timeout}.png")
...
def reset_sim(path_var, timeout):
    ...
    global sensing_tick, actuation_tick, last_cmd_time
