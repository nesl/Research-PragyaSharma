...
def plot_results(path, x_history, y_history, timeout):
    ...
    plt.plot(4, 5, marker="o", markersize=5, markerfacecolor="green")
    plt.axis("equal")
    plt.legend()
    # plt.show()
...
def env_setup(path_var):
    ...
    p.loadURDF("racecar/obstacles/sphere_small.urdf", [3, 0, 0], globalScaling = 5)
    p.loadURDF("racecar/obstacles/sphere_small.urdf", [4, -1.5, 0], globalScaling = 5)
    print("car:", car)
