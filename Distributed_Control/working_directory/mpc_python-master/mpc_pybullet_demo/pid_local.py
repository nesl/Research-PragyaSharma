...
def calc_accuracy(pid_path,  x_history, y_history):
    ...
    while idx!=len(x_history)-1:
        ...
        if err==0:
            err_array[idx] = 1
        elif err>0 or err<0.01:
            err_array[idx] = 0.9
        elif err>=0.01 or err<0.02:
            err_array[idx] = 0.8
        elif err>=0.02 or err<0.03:
            err_array[idx] = 0.7
        elif err>=0.03 or err<0.04:
            err_array[idx] = 0.6
        elif err>=0.04 or err<0.05:
            err_array[idx] = 0.5
        elif err>=0.05 or err<0.06:
            err_array[idx] = 0.4
        elif err>=0.06 or err<0.07:
            err_array[idx] = 0.3
        elif err>=0.07 or err<0.08:
            err_array[idx] = 0.2
        elif err>=0.08 or err<0.09:
            err_array[idx] = 0.1
        elif err>=0.09:
            err_array[idx] = 0
        idx = idx+1
